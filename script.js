function showWish() {
  ...
  const wishLines = [
    `Gửi ${name} thân yêu 🌷,\n`,
    "Hôm nay là ngày đặc biệt – ngày để tôn vinh một nửa thế giới tuyệt vời này 💖.\n\n",
    ...
    "Dù mai này có bận rộn, có những lúc mỏi mệt,\nhãy nhớ rằng bạn luôn xứng đáng được yêu thương,\nđược trân trọng và được hạnh phúc – không chỉ hôm nay mà là mỗi ngày trong suốt cuộc đời này 💕.\n\n",
